...
var TodoApp = {
    ...
    show: function () {
        ...
        for (var i = 0; i < todos.length; i++) {
            ...
            var todo = todos[i];
            html += '<li class="todo-item list-group-item ' + (todo.checked ? 'checked' : '') + '" id="' + todo.id + '">' 
                +  todo.text 
            + '<span class="btn btn-link remove"><i class="glyphicon glyphicon-remove" aria-hidden="true"></i></span></li>';
        };
